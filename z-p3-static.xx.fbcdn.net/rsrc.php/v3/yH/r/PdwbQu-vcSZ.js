if (self.CavalryLogger) {
    CavalryLogger.start_js(["mQtA7WG"]);
}
...
__d("TAALOpcode", [], (function(a, b, c, d, e, f) {
    "use strict";
    a = {
        PREVIOUS_FILE: 1,
        PREVIOUS_FRAME: 2,
...
__d("err", ["TAALOpcode"], (function(a, b, c, d, e, f) {
    "use strict";
    e.exports = a;
    ...
    function a(a) {
        ...
        c.taalOpcodes = [b("TAALOpcode").PREVIOUS_FRAME];
        return c
    }
}), null);
__d("$-core", ["TAALOpcode", "err"], (function(a, b, c, d, e, f) {
    e.exports = a;
    ...
    function g(a, c) {
        if (!c) {
            ...
            a.taalOpcodes = [b("TAALOpcode").PREVIOUS_FILE];
            throw a
        }
        return c
    }
...
__d("invariant", ["Env", "TAALOpcode", "sprintf"], (function(a, b, c, d, e, f) {
    "use strict";
    e.exports = a;
    var g;
    ...
    function a(a, c) {
        if (!a) {
            ...
            n.taalOpcodes = [b("TAALOpcode").PREVIOUS_FRAME];
            n.stack;
            throw n
        }
    }
...
__d("ErrorSerializer", ["ErrorMetadata"], (function(a, b, c, d, e, f) {
    ...
    function a(a, c) {
        ...
        if (d != null) {
            var e;
            e = (e = a.metadata) != null ? e : new(b("ErrorMetadata"))();
            d != null && e.addEntries.apply(e, d.getAll());
            a.metadata = e
        }
        ...
        c.blameModule != null && (a.blameModule = c.blameModule);
        e = (d = a.messageFormat) != null ? d : a.message;
        d = (d = a.messageParams) != null ? d : [];
        if (e !== c.messageFormat && c.messageFormat != null) {
            var f;
            e += " [Caught in: " + c.messageFormat + "]";
            d.push.apply(d, (f = c.messageParams) != null ? f : [])
        }
        a.messageFormat = e;
        a.messageParams = d;
        f = c.forcedKey;
        e = a.forcedKey;
        c = f != null && e != null ? f + "_" + e : (d = f) != null ? d : e;
        a.forcedKey = c
    }

    function c(a) {
        var b;
        return h((b = a.messageFormat) != null ? b : a.message, a.messageParams || [])
    }
...
__d("ErrorNormalizeUtils", ["ErrorMetadata", "ErrorSerializer", "ErrorXFBDebug", "TAALOpcode", "getSimpleHash", "performanceNow"], (function(a, b, c, d, e, f) {
    "use strict";
    ...
    function p(c) {
        var d, e, f, h, i, j, l = m(c);
        d = (d = c.taalOpcodes) != null ? d : [];
        var o = c.framesToPop;
        if (o != null) {
            o = Math.min(o, l.length);
            while (o-- > 0) d.unshift(b("TAALOpcode").PREVIOUS_FRAME)
        }
        o = (o = c.messageFormat) != null ? o : c.message;
        e = ((e = c.messageParams) != null ? e : []).map(function(a) {
            return String(a)
        });
        var q = n(c.componentStack),
            r = q == null ? null : q.map(k),
            s = c.metadata ? c.metadata.format() : new(b("ErrorMetadata"))().format();
        s.length === 0 && (s = void 0);
        var t = l.map(function(a) {
            return a.text
        }).join("\n");
        ...
        var u = c.type || "error",
            v = c.loggingSource,
            w = c.project;
        h = (h = c.lineNumber) != null ? h : c.line;
        i = (i = c.columnNumber) != null ? i : c.column;
        j = (j = c.fileName) != null ? j : c.sourceURL;
        var x = l.length > 0;
        x && h == null && (h = l[0].line);
        x && i == null && (i = l[0].column);
        x && j == null && (j = l[0].script);
        r = {
            blameModule: c.blameModule,
            column: i == null ? null : String(i),
            clientTime: Math.floor(Date.now() / 1e3),
            componentStackFrames: r,
            deferredSource: c.deferredSource != null ? p(c.deferredSource) : null,
            extra: (x = c.extra) != null ? x : {},
            fbtrace_id: c.fbtrace_id,
            guardList: (i = c.guardList) != null ? i : [],
            hash: b("getSimpleHash")(f, t, u, w, v),
            isNormalizedError: !0,
            line: h == null ? null : String(h),
            loggingSource: v,
            message: b("ErrorSerializer").toReadableMessage(c),
            messageFormat: o,
            messageParams: e,
            metadata: s,
            name: f,
        ...
        c.forcedKey != null && (r.forcedKey = c.forcedKey);
        d.length > 0 && (r.taalOpcodes = d);
        x = a.location;
        x && (r.windowLocationURL = x.href);
        for (var y in r) r[y] == null && delete r[y];
        return r
    }
...
__d("ErrorPubSub", ["ErrorBrowserConsole", "ErrorGuardState", "ErrorNormalizeUtils", "removeFromArray"], (function(a, b, c, d, e, f) {
    "use strict";
...
__d("getErrorSafe", ["TAALOpcode", "err"], (function(a, b, c, d, e, f) {
    "use strict";
    e.exports = a;
    ...
    function a(a) {
        ...
        if (c != null) {
            ...
            c.taalOpcodes.push(b("TAALOpcode").PREVIOUS_FRAME);
            return c
        }
        return a
    }
}), null);
__d("ErrorGuard", ["ErrorGuardState", "ErrorNormalizeUtils", "ErrorPubSub", "ErrorSerializer", "getErrorSafe"], (function(a, b, c, d, e, f) {
    "use strict";
            ...
            applyWithGuard: function(a, c, d, e) {
                ...
                try {
                    ...
                    try {
                        ...
                        l == null && a && (e.extra[a.toString().substring(0, 100)] = "function", d != null && d.length && (e.extra[Array.from(d).toString().substring(0, 100)] = "args"));
...
__d("FBLogMessage", ["ErrorMetadata", "ErrorNormalizeUtils", "ErrorPubSub", "ErrorSerializer", "TAALOpcode", "err"], (function(a, b, c, d, e, f) {
    "use strict";
    var g;
    a = function() {
        function a(a) {
        ...
        c.$1 = function(c, d) {
            ...
            if (this.normalizedError) {
            ...
            } else if (l) this.taalOpcodes.length > 0 && new a("fblogger").blameToPreviousFrame().blameToPreviousFrame().warn("Blame helpers do not work with catching"), b("ErrorSerializer").aggregateError(l, {
                messageFormat: e,
                ...
                project: h,
                type: c
            }), m = b("ErrorNormalizeUtils").normalizeError(l);
            else {
                l = new Error(e);
                if (l.stack === void 0) try {
                    throw l
                } catch (a) {}
                l.messageFormat = e;
                l.messageParams = b("ErrorSerializer").toStringParams(o);
                l.blameModule = j;
                l.forcedKey = k;
                l.project = h;
                l.type = c;
                l.taalOpcodes = [b("TAALOpcode").PREVIOUS_FRAME, b("TAALOpcode").PREVIOUS_FRAME].concat(this.taalOpcodes);
                m = b("ErrorNormalizeUtils").normalizeError(l);
                m.name = "FBLogger"
            }
            m.loggingSource = "FBLOGGER";
            i.isEmpty() || (m.metadata = i.format());
            if (f.length > 0)
                if (m.events != null) {
                    var r;
                    (r = m.events).push.apply(r, f)
                } else m.events = f;
        ...
        c.debug = function(a) {};
        c.mustfixThrow = function(a) {
            for (var c = arguments.length, d = new Array(c > 1 ? c - 1 : 0), e = 1; e < c; e++) d[e - 1] = arguments[e];
            var f = this.$1.apply(this, ["error", a].concat(d));
            f || (f = b("err")("mustfixThrow does not support catchingNormalizedError"), f.taalOpcodes = f.taalOpcodes || [], f.taalOpcodes.push(b("TAALOpcode").PREVIOUS_FRAME));
            throw f
        };
        ...
        c.blameToPreviousFile = function() {
            this.taalOpcodes.push(b("TAALOpcode").PREVIOUS_FILE);
            return this
        };
        c.blameToPreviousFrame = function() {
            this.taalOpcodes.push(b("TAALOpcode").PREVIOUS_FRAME);
            return this
        };
        c.blameToPreviousDirectory = function() {
            this.taalOpcodes.push(b("TAALOpcode").PREVIOUS_DIR);
            return this
        };
    ...
    a = function() {
        ...
        c.preload = function() {
            var a, b = this,
                c = (a = this.$2) != null ? a : k;
            j(function(a) {
                return a.jsResourcePreloadFull_INTERNAL() ? a.loadModules([b.getModuleIdAsRef()], function() {}, "preload: " + c) : a.preloadModules([b.getModuleId()], void 0, c)
            })
        };
        c.equals = function(a) {
...
__d("TAAL", ["TAALOpcode"], (function(a, b, c, d, e, f) {
    "use strict";
    ...
    function a(a) {
        var c;
        a.taalOpcodes = (c = a.taalOpcodes) != null ? c : [];
        a.taalOpcodes.push(b("TAALOpcode").PREVIOUS_FILE);
        return a
    }
    ...
    function c(a) {
        var c;
        a.taalOpcodes = (c = a.taalOpcodes) != null ? c : [];
        a.taalOpcodes.push(b("TAALOpcode").PREVIOUS_FRAME);
        return a
    }
    ...
    function d(a) {
        var c;
        a.taalOpcodes = (c = a.taalOpcodes) != null ? c : [];
        a.taalOpcodes.push(b("TAALOpcode").PREVIOUS_DIR);
        return a
    }
}), null);
...
__d("Bootloader", ["invariant", "BootloaderConfig", "BootloaderEndpoint", "BootloaderEvents", "BootloaderEventsManager", "CSRBitMap", "CSRIndexUtil", "CSSLoader", "ClientConsistency", "ErrorPubSub", "FBLogger", "JSResourceReference", "NetworkStatus", "RequireDeferredReference", "ResourceHasher", "ResourceTimingsStore", "TAAL", "TimeSlice", "cr:696703", "createTrustedScriptURLFromFacebookURI", "err", "ifRequireable", "nullthrows", "performanceAbsoluteNow", "performanceNow", "setTimeoutAcrossTransitions"], (function(a, b, c, d, e, f, g) {
    "use strict";
    var h, i, j, k = function() {},
        l = new Set(),
        m = !!b("BootloaderConfig").deferBootloads;
    m && !a.__comet_ssr_is_server_env_DO_NOT_USE && b("setTimeoutAcrossTransitions")(function() {
        $.undeferBootloads(!0)
    }, 15e3);
    var n = b("BootloaderConfig").retryQueuedBootloads,
        o = [],
        p = [],
        q = new Map(),
        r = new Map(),
    ...
    (h || (h = b("ErrorPubSub"))).unshiftListener(function(a) {
        var b = [];
        for (var c = q, d = Array.isArray(c), e = 0, c = d ? c : c[typeof Symbol === "function" ? Symbol.iterator : "@@iterator"]();;) {
            var f;
            if (d) {
                if (e >= c.length) break;
                f = c[e++]
    ...
    function K(a) {
        var c = u.get(a);
        if (!c) throw b("TAAL").blameToPreviousFile(b("err")("Bootloader: %s is not in the component map", a));
        return c
    }
    ...
    function M(a) {
        var c = w.get(a);
        if (!c) throw b("TAAL").blameToPreviousFile(b("err")("No resource entry for hash: %s", a));
        return c
    }
    ...
    function Q() {
        ...
        if (a < H) return !0;
        a = z[a - 1] - z[a - H];
        a < aa && (b("FBLogger")("bootloader").warn("JS retry abort"), I = !1);
        return I
    }

    function R(a, b, c, d) {
        if (q.has(a) || t.has(a)) return;
        t.add(a);
        var e = void 0;
        switch (b.type) {
            case "async":
    ...
    function T(a, c, d, e) {
        ...
        a.onerror = h.bind(void 0, function() {
            ...
            Q() && h < G.length ? (z.push(k), setTimeout(function() {
                if (!Q()) return;
                var b = a.parentNode;
                b && (b.removeChild(a), S(c, d, e, b))
            }, G[h]), y.set(f, h + 1)) : (s.set(c, k), b("FBLogger")("bootloader").warn("JS loading error [%s] at %s | time: %s | retries: %s | concurrency: %s", c, f, k - g, h, q.size - r.size), b("NetworkStatus").reportError(), e())
        })
    }

    function U(a, c, d) {
        return function() {
            b("FBLogger")("bootloader").warn("CSS timeout [%s] at %s | concurrency: %s", a, c.src, q.size - r.size), s.set(a, (i || (i = b("performanceAbsoluteNow")))()), b("NetworkStatus").reportError(), d()
        }
    }
    ...
    function V(a, c, d, e) {
        ...
        switch (c.type) {
            ...
            case "css":
                ...
                b("CSSLoader").loadStyleSheet(a, c.src, d, !c.nc, e, U(a, c, e));
                break;
            case "async":
    ...
    function W(a, c, d, e, f) {
        ...
        var j = [],
            k = [];
        for (var a = Y(a), l = Array.isArray(a), m = 0, a = l ? a : a[typeof Symbol === "function" ? Symbol.iterator : "@@iterator"]();;) {
            var n;
            if (l) {
                if (m >= a.length) break;
                n = a[m++]
            ...
            var r = F.rsrcDone(o);
            k.push(r);
            p !== "nonblocking" && (j.push(r), p === "blocking" && f.push(r));
            q.has(o) || h.set(o, n)
        }
        var s, t;
        ...
        for (var p = h, r = Array.isArray(p), o = 0, p = r ? p : p[typeof Symbol === "function" ? Symbol.iterator : "@@iterator"]();;) {
            if (r) {
                if (o >= p.length) break;
                n = p[o++]
            } else {
    ...
    function Z(a) {
        ...
        X(e, d, !0);
        q.set(e, (i || (i = b("performanceAbsoluteNow")))());
        var f = function() {
            return $.done(e)
        };
        c = d.type === "js" ? !a.getAttribute("async") : ((c = a.parentNode) == null ? void 0 : c.tagName) === "HEAD";
        c || window._btldr && window._btldr[e] ? f() : d.type === "js" ? T(a, e, d, f) : b("CSSLoader").setupEventListeners(e, d.src, O(), f, U(e, d, f), a)
    }
    ...
    var $ = {
        preloadModules: function(a, c, d) {
            ...
            P(function(a) {
                for (var b = Y(e), c = Array.isArray(b), f = 0, b = c ? b : b[typeof Symbol === "function" ? Symbol.iterator : "@@iterator"]();;) {
                    var g;
                    if (c) {
                        if (f >= b.length) break;
                        g = b[f++]
        ...
        loadModules: function(a, c, e) {
            ...
            F.registerCallback(d.bind(null, f, function() {
                m && (m.callbackStart = (i || (i = b("performanceAbsoluteNow")))()), h.apply(void 0, arguments), m && (m.callbackEnd = (i || (i = b("performanceAbsoluteNow")))()), F.notify(l)
            }), f.map(function(a) {
                return F.tierOne(a)
            }));
            P(function(b) {
        ...
        loadResources: function(a, c, d) {
            d === void 0 && (d = "loadResources: unknown caller"), ea(), P(function(e) {
                var f;
        ...
        requestJSResource_UNSAFE_NEEDS_REVIEW_BY_SECURITY_AND_XFN: function(a) {
            ...
            r.set(a, (i || (i = b("performanceAbsoluteNow")))()), window.CavalryLogger && window.CavalryLogger.done_js([a]), F.notify(F.rsrcDone(a))
        },
        ...
        enableBootload: function(a) {
            for (var b in a) u.has(b) || (u.set(b, a[b]), l.has(b) && (l["delete"](b), L(b)));
            ea();
            m || fa()
        },
        undeferBootloads: function(a) {
            ...
            a && m && b("BootloaderEvents").notifyDeferTimeout({
        ...
        setResourceMap: function(a, c, d) {
            ...
            for (var f in a) {
                ...
                var g = a[f],
                    h = w.get(f);
                !h ? (g.type === "js" && (e = !0), X(f, g, !1)) : (h.type === "js" && g.type === "js" || h.type === "css" && g.type === "css") && (g.d && !h.d && (g.type === "js" && (e = !0), h.src = g.src, h.d = 1))
            }
        ...
        getCSSResources: function(a) {
            var b = [];
            for (var a = Y(a), c = Array.isArray(a), d = 0, a = c ? a : a[typeof Symbol === "function" ? Symbol.iterator : "@@iterator"]();;) {
                var e;
                if (c) {
                    if (d >= a.length) break;
                    e = a[d++]
        ...
        jsResourcePreloadFull_INTERNAL: function() {
            return b("BootloaderConfig").jsResourcePreloadFull
        },
        __debug: {
            componentMap: u,
            requested: q,
...
__d("BootloaderEndpoint", ["Bootloader", "BootloaderEndpointConfig", "CSRFGuard", "ErrorXFBDebug", "FBLogger", "HasteResponse", "TimeSlice", "clearImmediate", "getAsyncParams", "getSameOriginTransport", "performanceAbsoluteNow", "setImmediateAcrossTransitions"], (function(a, b, c, d, e, f) {
    "use strict";
    ...
    a = {
        load: function(a, c, d) {
            ...
            if (k != null) return;
            j = b("TimeSlice").getGuardedContinuation("Schedule async batch request: Bootloader._loadResources");
...
__d("HasteResponse", ["Bootloader", "BootloaderEvents", "ClientConsistencyEventEmitter", "HasteSupportData", "ServerJS", "TimeSlice", "getSimpleHash", "performanceAbsoluteNow"], (function(a, b, c, d, e, f) {
    "use strict";
    var g, h = new Set(),
        i = {
            ...
            handle: function(a, c) {
                ...
                if (j == null) n = !0;
                    ...
                    var o = b("getSimpleHash")(f, j);
                    h.has(o) ? n = !1 : (n = !0, h.add(o))
                }
                a && i.handleSRPayload(a);
                var p = 0,
                    q = 0;
                b("Bootloader").loadResources((o = e) != null ? o : [], {
                    onBlocking: function() {
                        p = (g || (g = b("performanceAbsoluteNow")))(), new(b("ServerJS"))().handle(d || {}), q = g(), k == null ? void 0 : k()
                    },
                    onAll: c,
                    onLog: function(a) {
                        a = {
                ...
                }, "HasteResponse:" + f + ":" + ((a = j) != null ? a : "<unknown>"))
            }
        };
    e.exports = i
}), null);
...
__d("Event", ["$", "Arbiter", "DOMEvent", "DOMEventListener", "DOMQuery", "DataStore", "Env", "ErrorGuard", "EventProfiler", "ExecutionEnvironment", "FBLogger", "Parent", "Scroll", "TAAL", "TimeSlice", "UserAgent", "clickRefAction", "dedupString", "getDocumentScrollElement", "getObjectValues"], (function(a, b, c, d, e, f) {
    var g, h, i = "Event.listeners";
    ...
    c = {
        listen: function(a, c, d, e, f) {
            ...
            if (!a) {
                g = b("TAAL").blameToPreviousFrame(new Error("Cannot listen to an undefined element."));
